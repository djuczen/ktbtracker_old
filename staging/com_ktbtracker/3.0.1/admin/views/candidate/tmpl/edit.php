...
JFactory::getDocument()->addScriptDeclaration('
	...
	{
		if (task == "candidate.cancel" || document.formvalidator.isValid(document.getElementById("candidate-form")))
		{
...
');
?>
<form action="<?php echo JRoute::_('index.php?option=com_ktbtracker&layout=edit&id=' . (int) $this->item->id); ?>" method="post" id="adminForm" name="candidate-form" class="form-validate">
	...
	<input type="hidden" name="task" value="candidate.edit"/>
