...
JFactory::getDocument()->addScriptDeclaration('
	...
	{
		if (task == "tracker.cancel" || document.formvalidator.isValid(document.getElementById("tracker-form")))
		{
...
');
?>
<form action="<?php echo JRoute::_('index.php?option=com_ktbtracker&layout=edit&id=' . (int) $this->item->id); ?>" method="post" id="adminForm" name="tracker-form" class="form-validate">
	...
	<input type="hidden" name="task" value="tracker.edit"/>
