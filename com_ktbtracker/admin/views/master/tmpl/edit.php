...
JFactory::getDocument()->addScriptDeclaration('
	...
	{
		if (task == "master.cancel" || document.formvalidator.isValid(document.getElementById("master-form")))
		{
...
');
?>
<form action="<?php echo JRoute::_('index.php?option=com_ktbtracker&layout=edit&id=' . (int) $this->item->id); ?>" method="post" id="adminForm" name="master-form" class="form-validate">
	...
	<input type="hidden" name="task" value="master.edit"/>
