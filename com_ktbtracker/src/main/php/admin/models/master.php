...
/**
 * KTBTracker component model for master forms (Administration).
 * 
 * @since	1.0.0
 */
class KTBTrackerModelMaster extends JModelAdmin
{
	/**
	 ...
	 * @since 	1.0.0
	 */
	public function getTable($type = 'Masters', $prefix = 'KTBTrackerTable', $config = array())
	{
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm('com_ktbtracker.master', 'master', array (
				'control' => 'jform',
				'load_data' => $loadData 
		));
		...
		if ($id != 0 && (!$user->authorise('core.edit.state', 'com_ktbtracker.master.' . (int) $id))
